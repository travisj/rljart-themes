...
<?php if ($comments) : ?>
	...
	<?php foreach ($comments as $comment) : ?>
		<li class="<?php echo $oddcomment; ?>" id="comment-<?php comment_ID() ?>">
			<p class="cmtinfo"><cite><?php comment_author_link() ?></cite> on <?php comment_date('d M Y') ?> at <?php comment_time() ?> <a href="#comment-<?php comment_ID() ?>" title="">#</a> <?php edit_comment_link('edit this','',''); ?></p>
